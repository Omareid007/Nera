...
const COUNTRY_INDEX: Record<string, { symbol: string; name: string }> = {
  ...
  GR: { symbol: '^GD.AT', name: 'Athens General' },
  RO: { symbol: '^BET', name: 'BET Bucharest' },
  // Middle East & North Africa
  SA: { symbol: '^TASI.SR', name: 'Tadawul' },
  AE: { symbol: 'DFMGI.AE', name: 'DFM General' },
  QA: { symbol: '^QSI', name: 'QE All Share' },
  KW: { symbol: '^KWSE', name: 'Boursa Kuwait' },
  BH: { symbol: '^BAX', name: 'Bahrain All Share' },
  OM: { symbol: '^MSM', name: 'MSM 30' },
  EG: { symbol: '^EGX30.CA', name: 'EGX 30' },
  IL: { symbol: '^TA125.TA', name: 'TA-125' },
  TR: { symbol: 'XU100.IS', name: 'BIST 100' },
  MA: { symbol: '^MASI', name: 'MASI Casablanca' },
  JO: { symbol: '^AMGNRLX', name: 'Amman General' },
  // Asia-Pacific
  ...
  NG: { symbol: '^NGSEINDEX', name: 'NGX All Share' },
  KE: { symbol: '^NSE20', name: 'NSE 20 Share' },
  // Russia
