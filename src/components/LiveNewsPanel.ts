...
export const OPTIONAL_LIVE_CHANNELS: LiveChannel[] = [
  ...
  { id: 'livenow-fox', name: 'LiveNOW from FOX', handle: '@LiveNOWFOX', fallbackVideoId: 'mODFq9VR5Xc' },
  { id: 'newsmax', name: 'Newsmax', handle: '@NEWSMAX', fallbackVideoId: 'S-lFBzloL2Y', useFallbackOnly: true },
  { id: 'abc-news', name: 'ABC News', handle: '@ABCNews', fallbackVideoId: 'YVhFaGtjJHE' },
  ...
  { id: 'rt', name: 'RT', handle: '', fallbackVideoId: 'V0I5eglJMRI' },
  ...
  { id: 'record-news', name: 'Record News', handle: '@RecordNews', fallbackVideoId: 'r_OleL3bMjY' },
  ...
  { id: 'wion', name: 'WION', handle: '@WION', fallbackVideoId: '8jPQjjsBbIc' },
  ...
  { id: 'rudaw', name: 'Rudaw', hlsUrl: 'https://svs.itworkscdn.net/rudawlive/rudawlive.smil/playlist.m3u8', fallbackVideoId: 'KfGqDVxE1n0' },
  // Africa
...
const DIRECT_HLS_MAP: Readonly<Record<string, string>> = {
  ...
  'record-news': 'https://stream.ads.ottera.tv/playlist.m3u8',
